...
(function($PS) {
  ...
  var autocompleteCandidates = function (apiKey) {
      return function (partialCity) {
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)("https://api.geocode.city/autocomplete" + (prefix + ("q=" + partialCity))))(function (res) {
              ...
              throw new Error("Failed pattern match at Autocomplete.Internal (line 40, column 3 - line 52, column 70): " + [ res.constructor.name ]);
          });
      };
  };
  ...
  var component = function (apiKey) {
      var render = function (st) {
          ...
          var renderContainer = (function () {
              ...
              var renderItems = (function () {
                  ...
                  throw new Error("Failed pattern match at Autocomplete.Component (line 133, column 9 - line 139, column 56): " + [ st.available.constructor.name ]);
              })();
              return Autocomplete_Internal.whenElem(Data_Eq.eq(Select.eqVisibility)(st.visibility)(Select.On.value))(function (v) {
                  return Halogen_HTML_Elements.div(Select_Setters.setContainerProps([ Autocomplete_Internal.classes_([ "geocode-city__autocomplete-container", Data_Monoid.guard(Data_Monoid.monoidString)(hasItems)("geocode-city__autocomplete-container--hasItems") ]) ]))(renderItems);
              });
          })();
          var hasSelection = Data_Maybe.isJust(st.selection);
          var renderInput = Halogen_HTML_Elements.input(Select_Setters.setInputProps([ Autocomplete_Internal.classes_([ "geocode-city__autocomplete-input", Data_Monoid.guard(Data_Monoid.monoidString)(hasSelection)("geocode-city__autocomplete-input-selections"), Data_Monoid.guard(Data_Monoid.monoidString)(Data_Eq.eq(Select.eqVisibility)(st.visibility)(Select.On.value))("geocode-city__autocomplete-input-active") ]), Halogen_HTML_Properties.placeholder("Type to search..."), Halogen_HTML_Properties.value(Data_Maybe.maybe("")(Autocomplete_Internal.cityString)(st.selection)) ]));
      ...
      var input = {
          ...
          getItemCount: (function () {
              var $41 = Data_Maybe.maybe(0)(Data_Array.length);
              return function ($42) {
                  return $41(Network_RemoteData.toMaybe((function (v) {
                      return v.available;
                  })($42)));
              };
          })(),
      ...
      var handleEvent = function (v) {
                  ...
                  return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Network_RemoteData.foldableRemoteData)(st.available)(function (arr) {
                      return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(Data_Array.index(arr)(v.value0))(function (item) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $17.selection = new Data_Maybe.Just(item);
                              $17.search = "";
                              $17.visibility = Select.Off.value;
                              return $17;
                          }))(function () {
          ...
          if (v instanceof Select.Searched) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $21.available = Network_RemoteData.Loading.value;
                      return $21;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Autocomplete_Internal.autocompleteCandidates(st.apiKey)(v.value0)))(function (cities) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $24 = {};
                              for (var $25 in v1) {
          ...
          throw new Error("Failed pattern match at Autocomplete.Component (line 59, column 17 - line 79, column 39): " + [ v.constructor.name ]);
      };
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#geocode-city-autocomplete"))(function (container) {
          ...
          if (container instanceof Data_Maybe.Just) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(removeChildren(Web_DOM_Element.toNode(asElement))))(function () {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_DOM_Element.getAttribute("data-api-key")(asElement)))(function (apiKey) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Autocomplete_Component.component(apiKey))(Data_Unit.unit)(container.value0))(function (io) {
                          ...
                          return io.subscribe(Control_Coroutine.consumer(Effect_Aff.monadAff)(function (msg) {
                              ...
                              throw new Error("Failed pattern match at Main (line 37, column 9 - line 45, column 25): " + [ msg.constructor.name ]);
                          }));
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Main (line 27, column 3 - line 45, column 25): " + [ container.constructor.name ]);
      });
  }));
  exports["main"] = main;
